...
namespace ImGui
{
	...
	IMGUI_API bool			ButtonT(const char* label, const ImVec2& size_arg, int page, int in, ImColor clr, bool border = true);
	...
	IMGUI_API bool          SliderFloat5(const char* label, float* v, float v_min, float v_max, const char* display_format = "%.3f", float power = 1.0f, float width = 200);
	IMGUI_API bool          SliderAngle(const char* label, float* v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f, const char* format = "%.0f deg");
	IMGUI_API bool          SliderInt(const char* label, int* v, int v_min, int v_max, const char* format = "%d");
	IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = "%d");
	IMGUI_API bool          SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format = "%d");
	IMGUI_API bool          SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format = "%d");
	IMGUI_API bool			SliderInt5(const char* label, int* v, int v_min, int v_max, const char* display_format = "%.0f");
...
struct ImGuiStyle
{
	...
	float       FrameRounding2;              // Radius of frame corners rounding. Set to 0.0f to have rectangular frame (used by most widgets).
